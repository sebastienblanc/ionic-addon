...
import static org.jboss.forge.addon.ionic.ResourceProvider.ANGULAR_RESOURCE_JS;
import static org.jboss.forge.addon.ionic.ResourceProvider.IONICONS_SVG;
import static org.jboss.forge.addon.ionic.ResourceProvider.IONICONS_TTF;
import static org.jboss.forge.addon.ionic.ResourceProvider.IONIC_BUNDLE_JS;
import static org.jboss.forge.addon.ionic.ResourceProvider.IONIC_CSS;
import static org.jboss.forge.addon.ionic.ResourceProvider.LANDING_VIEW;
import static org.jboss.forge.addon.ionic.ResourceProvider.MAIN_CSS;
import static org.jboss.forge.addon.ionic.ResourceProvider.getEntityTemplates;
import static org.jboss.forge.addon.ionic.ResourceProvider.getGlobalTemplates;
import static org.jboss.forge.addon.ionic.ResourceProvider.getStatics;
...
public class AngularScaffoldProvider implements ScaffoldProvider
{
   ...
   public boolean isSetup(ScaffoldSetupContext setupContext)
   {
      ...
      {
         WebResourcesFacet web = project.getFacet(WebResourcesFacet.class);
         boolean areResourcesInstalled = web.getWebResource(targetDir + IONICONS_SVG).exists()
                  && web.getWebResource(targetDir + IONICONS_SVG).exists()
                  && web.getWebResource(targetDir + IONICONS_TTF).exists()
                  && web.getWebResource(targetDir + IONIC_BUNDLE_JS).exists()
                  && web.getWebResource(targetDir + MAIN_CSS).exists()
                  && web.getWebResource(targetDir + IONIC_CSS).exists()
   ...
   public List<Resource<?>> generateFrom(ScaffoldGenerationContext generationContext)
   {
      ...
      String targetDir = "../../../../" + project.getFacet(MetadataFacet.class).getProjectName() + "Client/www/";
      System.out.println("TARGET DIR NEW " + targetDir);
     // targetDir = (targetDir == null) ? "" : targetDir;
